...
import { ClassicEngine, Engine } from "./engine";
...
const newEngine: Engine = new AdapterEngine(new NewFancyEngine());
const loopWithNew = new GameLoop(newEngine);
loopWithNew.bootstrap();
loopWithNew.tick();
